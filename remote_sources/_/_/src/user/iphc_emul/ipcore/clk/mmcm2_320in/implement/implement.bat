...
xst -ifn xst.scr
move mmcm2_320in_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mmcm2_320in_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mmcm2_320in_exdes.ucf mmcm2_320in_exdes

echo 'Running map'
map -timing -pr b mmcm2_320in_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm mmcm2_320in_exdes -w routed.ncd routed.vhd
cd ..
